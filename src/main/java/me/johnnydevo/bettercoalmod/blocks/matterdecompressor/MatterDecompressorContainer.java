...
public class MatterDecompressorContainer extends Container {
    ...
    public MatterDecompressorContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, IIntArray fields) {
        super(ModContainers.MATTER_DECOMPRESSOR.get(), windowId);
    ...
    public boolean stillValid(PlayerEntity pPlayer) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()), pPlayer, ModBlocks.MATTER_DECOMPRESSOR.get());
    }
