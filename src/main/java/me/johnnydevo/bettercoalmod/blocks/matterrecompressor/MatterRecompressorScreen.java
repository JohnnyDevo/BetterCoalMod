...
public class MatterRecompressorScreen extends ContainerScreen<MatterRecompressorContainer> {
    public static final ResourceLocation TEXTURE = new ResourceLocation(BetterCoalMod.MOD_ID, "textures/gui/matter_recompressor.png");
